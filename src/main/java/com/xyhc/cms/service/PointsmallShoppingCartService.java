 ...
 */
public interface PointsmallShoppingCartService extends IService<PointsmallShoppingCartEntity> {

    /**
     * 查询全部
     *
     * @param params
     * @return List<PointsmallShoppingCartEntity>
     */
     ...
     * 保存
     *
     * @param  pointsmallShoppingCart pointsmallShoppingCart
     * @return boolean
     */
