 ...
 */
public interface PointsmallOrderCommodityService extends IService<PointsmallOrderCommodityEntity> {

    /**
     * 查询全部
     *
     * @param params
     * @return List<PointsmallOrderCommodityEntity>
     */
     ...
     * 保存
     *
     * @param  pointsmallOrderCommodity pointsmallOrderCommodity
     * @return boolean
     */
