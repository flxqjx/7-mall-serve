 ...
 */
public interface PointsmallCommentReplyService extends IService<PointsmallCommentReplyEntity> {

    /**
     * 查询全部
     *
     * @param params
     * @return List<PointsmallCommentReplyEntity>
     */
     ...
     * 保存
     *
     * @param  pointsmallCommentReply pointsmallCommentReply
     * @return boolean
     */
