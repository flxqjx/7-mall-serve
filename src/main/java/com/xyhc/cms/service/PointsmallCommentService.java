 ...
 */
public interface PointsmallCommentService extends IService<PointsmallCommentEntity> {

    /**
     * 查询全部
     *
     * @param params
     * @return List<PointsmallCommentEntity>
     */
     ...
     * 保存
     *
     * @param  pointsmallComment pointsmallComment
     * @return boolean
     */
