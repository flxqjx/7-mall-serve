 ...
 */
public interface CommodityShoppingCartService extends IService<CommodityShoppingCartEntity> {

    /**
     * 查询全部
     *
     * @param params
     * @return List<CommodityShoppingCartEntity>
     */
     ...
     * 保存
     *
     * @param  commodityShoppingCart commodityShoppingCart
     * @return boolean
     */
